                ...
                <div className="row align-items-center">
                    <div className="col-md-4 text-center text-md-start mb-4 mb-md-0">
                        <Link to="/" className="d-flex align-items-center justify-content-center justify-content-md-start text-decoration-none">
                            <img src="/src/img/logo-pagina.png" alt="Logo" width="40" className="me-2" />
                    ...
                    <div className="col-md-4 text-center text-md-end">
                        <div className="d-flex justify-content-center justify-content-md-end gap-3">
                            <Link to="/preguntas" className="text-decoration-none text-muted small">FAQ</Link>
                            <Link to="/caracteristicas" className="text-decoration-none text-muted small">Sobre nosotros</Link>
                        </div>
